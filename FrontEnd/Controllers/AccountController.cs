...
namespace CrowdFunding.Controllers
{
    ...
    public class AccountController : Controller
    {
                ...
                try
                {
                    WebSecurity.CreateUserAndAccount(model.UserName, model.Password,
                        new
                        {
                            ...
                            WorkHourFrom = "00:00",
                            WorkHourTo = "23:59",
                            RestrictAccessByIP = model.RestrictAccessByIP
                        }, false);
        ...
        {
            AngelikooContext db = new AngelikooContext();
            ...
            if (ModelState.IsValid)
            {
                ...
                using (UsersContext db = new UsersContext())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        db.UserProfiles.Add(new UserProfile(model.UserName, "@@@", true, true, 127, "00:00", "23:59", false));
                        db.SaveChanges();
